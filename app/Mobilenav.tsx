...
const mobilenav = () => {
  ...
  return (
    <div className=' flex flex-col  z-50 md:hidden absolute w-screen '>
        ...
        <nav className={`${nav ? 'visible w-screen flex justify-end  ' : " hidden"} `}>
            <ul className=" text-white flex flex-col gap-6 text-xl uppercase  py-32 px-6 bg-[rgba(128,109,109,0.1)] w-3/4 h-screen backdrop-filter  backdrop-blur-md  bg-opacity-30 ">
